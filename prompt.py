...
def prompt(input, prompt_path, return_num, embedding_model,
    ...
    major_courses = get_sim(input, return_num, embedding_model, major_course, major_course_embed)
    courses = get_sim(input, return_num, embedding_model, course_data, course_embed)
...
if __name__ == '__main__':
    ...
    prompt_gpt = prompt("What are some 300 level cs classes", "prompts/detailedPromptInfo.txt", 5, embedding_model)
